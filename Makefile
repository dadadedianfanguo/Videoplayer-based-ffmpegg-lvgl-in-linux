...
ifdef VM
    CC       = gcc
    CFLAGS  ?= -O0 -g -I$(LVGL_DIR)/ -I$(LVGL_DIR)/generated $(WARNINGS) -DLV_USE_SDL=1 -DLV_USE_LINUX_FBDEV=0
    LDFLAGS ?= -lm -lpthread -lSDL2
else
    CC       = arm-linux-gnueabihf-gcc
    CFLAGS  ?= -O3 -g -fno-omit-frame-pointer -funwind-tables -I$(LVGL_DIR)/ -I$(LVGL_DIR)/generated $(WARNINGS) -DLV_USE_SDL=0 -DLV_USE_LINUX_FBDEV=1 \
               -I$(HOME)/ffmpeg-armhf/include -I$(HOME)/alsa-armhf/include
    LDFLAGS ?= -static -rdynamic -lpthread \
               -L$(HOME)/ffmpeg-armhf/lib -L$(HOME)/alsa-armhf/lib \
...
WARNINGS		:= -Wall -Wshadow -Wundef -Wmissing-prototypes -Wno-discarded-qualifiers -Wextra -Wno-unused-function -Wno-error=strict-prototypes -Wpointer-arith \
					...
					-Wshift-negative-value -Wstack-usage=2048 -Wno-unused-value -Wno-unused-variable -std=gnu99
...
CSRCS += $(shell find generated -name "*.c")
